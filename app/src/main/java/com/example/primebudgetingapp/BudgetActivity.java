        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap : snapshot.getChildren()) {
                    ...
                    String sTotal = String.valueOf("Month budget: Ksh." + totalAmount);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder holder, final int position, @NonNull final Data model) {
                ...
                holder.setItemAmount("Allocated amount: Ksh. " + model.getAmount());
                ...
                switch (model.getItem()) {
                    ...
                    case "Food":
                        holder.imageView.setImageResource(R.drawable.ic_action_food);
                        break;

                    case "House":
                        holder.imageView.setImageResource(R.drawable.ic_action_home);
                        break;

                    case "Entertainment":
                        holder.imageView.setImageResource(R.drawable.ic_action_enter);
                        break;

                    case "Education":
                        holder.imageView.setImageResource(R.drawable.ic_action_edu);
                        break;

                    case "Charity":
                        holder.imageView.setImageResource(R.drawable.ic_action_char);
                        break;

                    case "Apparel":
                        holder.imageView.setImageResource(R.drawable.ic_action_app);
                        break;
                    case "Health":
                        holder.imageView.setImageResource(R.drawable.ic_action_hea);
                        break;
                    case "Personal":
                        holder.imageView.setImageResource(R.drawable.ic_action_per);
                        break;
                    case "Other":
                        holder.imageView.setImageResource(R.drawable.ic_action_other);
                        break;
